  ...
  <div class="row slideanim">
    <div class="col-md-9">
      ...
      <p>Is to ensure that we always have a realistic plan in restructuring our client’s strategic business
         ...
         competitive edge from all aspects to clients but most of all is making them money. Our highly skilled
          ...
          <div class="container-80 center-page">
              <div class="col-md-10 center-page p-b-30">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="s" class="form-control" placeholder="Job Title, Skills or Keywords" style="height: 67px;width:340px; margin-left: 5px;">
                  <select name="c" class="form-control" style="height: 67px; width:290px;" required>
